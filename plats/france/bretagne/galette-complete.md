...
> 🔗 **Base :** préparer d'abord la pâte → [Pâte à Galettes de Sarrasin](../../boulangerie/galette-sarrasin.md)

| Préparation | Cuisson | Portions |
| :--- | :--- | :--- |
| 5 min | 4 min | 1 galette |

## 🛒 Ingrédients (par galette)
- [ ] 1 galette de sarrasin cuite (voir base)
- [ ] 1 œuf
- [ ] 1 tranche de jambon blanc
- [ ] 30 g d'emmental râpé (ou comté)
- [ ] Beurre demi-sel
- [ ] Sel, poivre
